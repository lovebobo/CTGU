...
public class ExamMessageFragment extends BackHandledFragment {
  ...
  //表示的是教务处的哪个栏目,0表示即时消息，1表示考试栏目
	...
	private void initdata(){
		...
		progressDialog.setMessage("正在努力加载数据中，请耐心等候...");
  		Object ob = FileIO.getObjectFromFile(getActivity(), URLs.examnewsfile);
  		if(ob != null){
	...
	public void onDestroyView() {
		...
		if(newsSummaryList.size() > 0){
			...
			FileIO.saveObjectToFile(getActivity(), URLs.examnewsfile, saveList);
		}
		super.onDestroyView();
	}
